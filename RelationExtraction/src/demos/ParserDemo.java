...
//		}
		for (TypedDependency td : tdl) {
			...
			System.out.println(td.gov().lemma());
			System.out.println(td.gov().ner());
			System.out.println(td.gov().tag());
			System.out.println(td.gov().word());
//			System.out.println(td.gov().backingLabel().index());			
//			System.out.println(td.dep().backingLabel().index());
