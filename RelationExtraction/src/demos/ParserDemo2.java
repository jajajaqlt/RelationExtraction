...
class ParserDemo2 {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length > 1) {
			...
			String sent2 = "None of the 15 patients with supradiaphragmatic disease who received limited-field radiotherapy to regions that did not include the mediastinal or hilar nodes subsequently experienced relapse there.";
