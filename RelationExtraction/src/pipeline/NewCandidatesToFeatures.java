...
public class NewCandidatesToFeatures {
	...
	private void constructDependencyPath(Sentence sentence,
			Collection<TypedDependency> tdl) throws Exception {
	...
	public void writeFeatures(int index) throws Exception {
		...
		for (Sentence s : sentences) {
			...
			header += "cui1-global-phrase-index: " + s.entity1Index + newLine;
			...
			header += "cui2-global-phrase-index: " + s.entity2Index + newLine;
			...
			/**
			 * Reasons for not doing long-path: 1. Takes time and effect is not
			 * clear. 2. On average, a sentence is not very long due to nature
			 * of abstract.
			 */
			String arrow, type;
